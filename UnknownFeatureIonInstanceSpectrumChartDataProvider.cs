...
namespace OpenMS.AdapterNodes
{
	...
	public class UnknownFeatureIonInstanceSpectrumChartDataProvider : SpectrumChartDataProvider
	{
		...
		public override SpectrumChartData CreateSpectrumDetails(MassSpectrumItem massSpectrumItem)
		{
			...
			return new SpectrumChartData
			       {
				       ...
				       Spectrum = spectrum,
				       SpectrumHeaderText = CreateSpectrumChartHeader(spectrum, m_extraHeaderLine)
			       };
		}
